    ...
    return (
        <div className="min-h-screen bg-background pt-2 flex flex-col">
            ...
            <div id={'nav-and-content'} className={'flex flex-row items-start justify-between'}>
                <Nav className={'flex flex-col mt-24 ml-6 mr-3'} svgClassName={"h-12 w-12 text-black"}/>
                <main className={'pt-4 flex flex-col justify-center items-center'}>
                    {children}
                </main>
                <Nav className={'flex flex-col mt-24 ml-6 mr-3 opacity-0'} svgClassName={"h-12 w-12 text-black"}/>
            </div>
        </div>
    );
}
