                        ...
                        <div>
                            <div className="inline-flex">
                                <button className="hover:bg-gray-400 text-white font-bold py-2 px-4 rounded-l">
                                    <svg className="h-8 w-8 text-purple-900" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">  <path stroke="none" d="M0 0h24v24H0z" />  <path d="M9 11l-4 4l4 4m-4 -4h11a4 4 0 0 0 0 -8h-1" /></svg></button>
                            </div>
                        </div>
                    </div>
                    {/* Dashboard End*/}
                            ...
                            <div className="mt-[40px]">
                                <div className="hidden w-full md:block md:w-auto items-center" id="navbar-default">
                                    <ul className="flex flex-col p-2 mt-2 ">
                                        <li>
                                            <a href="#" className="block p-2 dark:hover:bg-gray-300" aria-current="page"><svg className="h-9 w-9 text-black" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg></a>
                                        </li>
                                        <li>
                                            <a href="#" className="block p-2 dark:hover:bg-gray-300" aria-current="page"><svg className="h-9 w-9 text-black" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">  <path stroke="none" d="M0 0h24v24H0z" />  <path d="M10 3.2a9 9 0 1 0 10.8 10.8a1 1 0 0 0 -1 -1h-6.8a2 2 0 0 1 -2 -2v-7a.9 .9 0 0 0 -1 -.8" />  <path d="M15 3.5a9 9 0 0 1 5.5 5.5h-4.5a1 1 0 0 1 -1 -1v-4.5" /></svg>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" className="block p-2 dark:hover:bg-gray-300" aria-current="page"><svg className="h-9 w-9 text-black" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="rectangle bg-white ml-20 mr-5 w-[100%] h-[390px] rounded-[10px] p-5">
                            <form className="items-center">
                                <div className=' w-[100%] flex justify-between items-center'>
                                    ...
                                    <div><button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" className="text-white mr-4 pl-2 pr-2 rounded-lg bg-[#AFACD3] md:hover:text-purple-100 font-medium flex items-center justify-between w-full md:w-auto">+ Add Filter</button>
