                    ...
                    <div id="purple container"
                        ...
                        <div id="form" className="pt-16">
                            ...
                            <div id="team member name"
                                ...
                                <Typography sx={{minWidth: 1}}
                                            variant='h7'> {team.employee.first_name + ' ' + team.employee.last_name} </Typography>
                            </div>
                            <InputWithIcon
                                input={<UtilizationInput defaultValue={team.utilization} onChange={updateFormData}/>}
